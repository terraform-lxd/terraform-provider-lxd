		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("incus_instance.instance1", "name", instanceName),
					resource.TestCheckTypeSetElemNestedAttrs("incus_instance.instance1", "device.*", map[string]string{"properties.path": "/tmp/shared"}),
					testAccInstanceRunning(t, "incus_instance.instance1", &instance),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("incus_instance.instance1", "name", instanceName),
					resource.TestCheckTypeSetElemNestedAttrs("incus_instance.instance1", "device.*", map[string]string{"properties.path": "/tmp/shared2"}),
					testAccInstanceRunning(t, "incus_instance.instance1", &instance),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccInstanceRunning(t, "incus_instance.instance1", &instance),
					resource.TestCheckResourceAttr("incus_instance.instance1", "name", instanceName),
					resource.TestCheckResourceAttr("incus_instance.instance1", "ip_address", "10.150.19.200"),
					resource.TestCheckResourceAttr("incus_instance.instance1", "ipv4_address", "10.150.19.200"),
					resource.TestCheckResourceAttr("incus_instance.instance1", "ipv6_address", "fd42:474b:622d:259d:216:3eff:fe39:7f36"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccInstanceRunning(t, "incus_instance.instance1", &instance),
					testAccInstanceRunning(t, "incus_instance.instance2", &instance),
...
func testAccInstance_accessInterface(networkName1, instanceName string) string {
	return fmt.Sprintf(`
resource "incus_network" "network_1" {
  name = "%s"
...
resource "incus_instance" "instance1" {
  ...
  device {
    ...
    properties = {
      nictype = "bridged"
      parent = "${incus_network.network_1.name}"
