...
func resourceIncusStoragePool() *schema.Resource {
	return &schema.Resource{
		Create: resourceIncusStoragePoolCreate,
		Update: resourceIncusStoragePoolUpdate,
		Delete: resourceIncusStoragePoolDelete,
		Exists: resourceIncusStoragePoolExists,
		Read:   resourceIncusStoragePoolRead,
		Importer: &schema.ResourceImporter{
			State: resourceIncusStoragePoolImport,
		},
...
func resourceIncusStoragePoolCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIncusStoragePoolRead(d, meta)
}

func resourceIncusStoragePoolRead(d *schema.ResourceData, meta interface{}) error {
	p := meta.(*incusProvider)
	server, err := p.GetInstanceServer(p.selectRemote(d))
	if err != nil {
		return err
...
func resourceIncusStoragePoolUpdate(d *schema.ResourceData, meta interface{}) error {
	p := meta.(*incusProvider)
	server, err := p.GetInstanceServer(p.selectRemote(d))
	if err != nil {
		return err
...
func resourceIncusStoragePoolDelete(d *schema.ResourceData, meta interface{}) (err error) {
	p := meta.(*incusProvider)
	server, err := p.GetInstanceServer(p.selectRemote(d))
	if err != nil {
		return err
...
func resourceIncusStoragePoolExists(d *schema.ResourceData, meta interface{}) (exists bool, err error) {
	p := meta.(*incusProvider)
	server, err := p.GetInstanceServer(p.selectRemote(d))
	if err != nil {
		return false, err
...
func resourceIncusStoragePoolImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	p := meta.(*incusProvider)
