		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccStoragePoolExists(t, "incus_storage_pool.storage_pool1", &pool),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccStoragePoolExists(t, "incus_storage_pool.storage_pool1", &pool),
					resource.TestCheckResourceAttr("incus_storage_pool.storage_pool1", "name", poolName),
					resource.TestCheckResourceAttr("incus_storage_pool.storage_pool1_node1", "config.source", source),
					resource.TestCheckResourceAttr("incus_storage_pool.storage_pool1_node2", "config.source", source),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccStoragePoolExistsInProject(t, "incus_storage_pool.storage_pool1", &pool, projectName),
				),
			},
		},
	})
