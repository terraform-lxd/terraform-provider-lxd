...
func resourceIncusCachedImage() *schema.Resource {
	return &schema.Resource{
		Create: resourceIncusCachedImageCreate,
		Update: resourceIncusCachedImageUpdate,
		Delete: resourceIncusCachedImageDelete,
		Exists: resourceIncusCachedImageExists,
		Read:   resourceIncusCachedImageRead,
...
func resourceIncusCachedImageCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIncusCachedImageRead(d, meta)
}

func resourceIncusCachedImageUpdate(d *schema.ResourceData, meta interface{}) error {
	p := meta.(*incusProvider)
...
func resourceIncusCachedImageDelete(d *schema.ResourceData, meta interface{}) error {
	p := meta.(*incusProvider)
	remote := p.selectRemote(d)
	server, err := p.GetInstanceServer(remote)
	if err != nil {
...
func resourceIncusCachedImageExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	p := meta.(*incusProvider)
	remote := p.selectRemote(d)
	server, err := p.GetInstanceServer(remote)
	if err != nil {
...
func resourceIncusCachedImageRead(d *schema.ResourceData, meta interface{}) error {
	p := meta.(*incusProvider)
	remote := p.selectRemote(d)
	server, err := p.GetInstanceServer(remote)
	if err != nil {
