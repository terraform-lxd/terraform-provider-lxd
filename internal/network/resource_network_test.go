		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("lxd_network.eth1", "config_state.ipv6.nat"),
					resource.TestCheckResourceAttrSet("lxd_network.eth1", "config_state.ipv6.address"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.PrintResourceState(t, "lxd_instance.instance1"),
					resource.TestCheckResourceAttr("lxd_instance.instance1", "name", instanceName),
					resource.TestCheckResourceAttr("lxd_instance.instance1", "status", "Running"),
					resource.TestCheckResourceAttr("lxd_instance.instance1", "device.#", "1"),
					resource.TestCheckResourceAttr("lxd_instance.instance1", "device.0.properties.parent", "eth1"),
