		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lxd_cached_image.img1", "source_image", "alpine/3.18"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lxd_cached_image.img1vm", "source_image", "alpine/3.18"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lxd_cached_image.img2", "source_image", "alpine/3.18"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lxd_cached_image.img3", "source_image", "alpine/3.18"),
					...
					resource.TestCheckTypeSetElemAttr("lxd_cached_image.img3", "aliases.*", "alpine/3.18"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lxd_cached_image.img4", "source_image", "alpine/3.18"),
					...
					resource.TestCheckResourceAttr("lxd_cached_image.img4", "aliases.0", "alpine/3.18/amd64"),
